🛡️Day 2: Credential Storage & Authentication Internals
...
🧪 Practical Evidence
<details> <summary>🐧 /etc/shadow — SHA-512 hash entry (Ubuntu VM)</summary>
...
</details> <details> <summary>🪟 Event ID 4624 — Service Logon (Windows Security Log)</summary>
...
🛡️ SOC note: Logon Type 5 from services.exe with no network address is normal
...
⚠️ NTLM's lack of salting is a structural weakness — pass-the-hash exploits the
